 ...
 * @author Vinh
 */
public class ScheduledFrm extends javax.swing.JFrame {
    ...
    public ScheduledFrm(User user, Tournament tournament) {
        this.user=user;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BXH Round "+tournament.getListRound().size());

        PlayerDAO playerDAO=new PlayerDAO();
        list=playerDAO.findByTournament(tournament.getId());
        for(Player i:list){
            tournament.setTongDiem(i);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(this.tournament.getListRound().size()<11){
